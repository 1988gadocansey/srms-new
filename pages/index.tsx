...
import logo from '../public/stsnew-01.png'
                        ...
                        <div className="sm:text-center lg:text-left">
                            ...
                            <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                <div className="rounded-md shadow">
                                    <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10"> Click to Login </a>
                                </div>
                                <div className="mt-3 sm:mt-0 sm:ml-3">
                                    <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10"> Help </a>
                                </div>
                            </div>
                        </div>
                    </main>
           ...
           {/* <footer>
                <div style={{ position: "absolute", bottom: 0, width:"100%" }} className="">
                    <div className="mx-auto px-6 pt-10 pb-6">
                        <center>©{new Date().getFullYear()} All rights reserved - Takoradi Technical University.</center>
                    </div>
                </div>
            </footer>*/}
            </>
